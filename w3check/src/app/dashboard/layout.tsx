...
export default function ResultsLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: 'Results', href: '/results-page', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Side Navigation */}
      <nav className="h-screen w-64 fixed bg-emerald-800 shadow-xl py-8 px-4">
        <Link href="/" className="mb-10 flex items-center cursor-pointer">
          <svg className="h-8 w-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
          <span className="ml-3 text-xl font-semibold text-white">W3Check</span>
        </Link>
            ...
            <Link 
              ...
              className={`flex items-center px-4 py-3 text-sm ${
                pathname.includes(item.href) 
                  ...
                  : 'text-emerald-100 hover:bg-emerald-700 hover:text-white rounded-lg'
              }`}
            >
