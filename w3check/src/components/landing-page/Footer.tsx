...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#18191A] text-white min-h-screen flex flex-col justify-center pt-32 pb-20">
      <div className="max-w-5xl mx-auto px-4 flex flex-col items-center w-full h-full">
        {/* CTA Section */}
        <div className="text-center mb-32">
          <h2 className="text-4xl md:text-4xl  mb-6">Connect with buyers when it matters</h2>
          <p className="text-gray-400 mb-12 max-w-2xl mx-auto text-lg">
            Hundreds of high growth companies like Justworks, Together AI, Guru, and Flock Safety power go-to-market with W3Check.
          </p>
          <form className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full max-w-xl mx-auto mb-4">
            <input
              type="email"
              placeholder="What's your work email?"
              className="w-full sm:w-auto flex-1 px-5 py-3 rounded border border-gray-700 bg-transparent text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white text-base"
            />
            <button
              type="submit"
              className="bg-white text-black px-8 py-3 rounded font-medium hover:bg-gray-200 transition-colors text-base"
            >
              Get started
            </button>
          </form>
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-20 mb-24">
          {columns.map((col) => (
            <div key={col.heading}>
              <div className="text-base font-medium mb-7 text-gray-300">{col.heading}</div>
        ...
        {/* Bottom Bar */}
        <div className="w-full border-t border-gray-800 pt-8 flex flex-col md:flex-row md:justify-between md:items-center text-base text-gray-500">
          ...
          <div className="flex items-center gap-6 mt-2 md:mt-0">
            ...
            <a href="#" aria-label="YouTube" className="hover:text-white"><svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a2.994 2.994 0 0 0-2.112-2.112C19.692 3.5 12 3.5 12 3.5s-7.692 0-9.386.574a2.994 2.994 0 0 0-2.112 2.112C0 7.88 0 12 0 12s0 4.12.502 5.814a2.994 2.994 0 0 0 2.112 2.112C4.308 20.5 12 20.5 12 20.5s7.692 0 9.386-.574a2.994 2.994 0 0 0 2.112-2.112C24 16.12 24 12 24 12s0-4.12-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
          </div>
        </div>
      </div>
    </footer>
